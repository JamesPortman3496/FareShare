...
let MOCK_EXPENSES: Record<string, Expense[]> = {
  "693d1183-dd55-4292-a1af-e2ef8aa8db97": [
    ...
    },
    {
      ...
      groupId: "693d1183-dd55-4292-a1af-e2ef8aa8db97",
      date: "2024-10-31",
      description: "Airport taxis (two cars)",
      amount: 80,
      currency: "GBP",
      paidBy: { email: "adam.deegan@gmail.com", name: "Adam" },
      owes: [
        { email: "adam.deegan@gmail.com", amount: 40 },
        { email: "charlie.haslam@gmail.com", amount: 40 },
      ],
      createdAt: "2024-10-31T18:25:00.000Z",
    },
    {
      id: "exp-8",
      groupId: "693d1183-dd55-4292-a1af-e2ef8aa8db97",
      date: "2024-10-30",
      description: "Lunch at harbor",
      amount: 110,
      currency: "GBP",
      paidBy: { email: "hcooney98@gmail.com", name: "Hannah" },
      owes: [
        { email: "james.portman3496@gmail.com", amount: 55 },
        { email: "hcooney98@gmail.com", amount: 55 },
      ],
      createdAt: "2024-10-30T13:40:00.000Z",
    },
    {
      id: "exp-9",
      groupId: "693d1183-dd55-4292-a1af-e2ef8aa8db97",
      ...
      paidBy: { email: "krystof.gora@gmail.com", name: "Krystof" },
      owes: [
        { email: "james.portman3496@gmail.com", amount: 8 },
        { email: "hcooney98@gmail.com", amount: 8 },
        { email: "adam.deegan@gmail.com", amount: 8 },
        { email: "krystof.gora@gmail.com", amount: 8 },
      ],
    ...
    },
    {
      ...
      paidBy: { email: "charlie.haslam@gmail.com", name: "Charlie" },
      owes: [
        { email: "charlie.haslam@gmail.com", amount: 50 },
        { email: "krystof.gora@gmail.com", amount: 50 },
        { email: "adam.deegan@gmail.com", amount: 50 },
      ],
      createdAt: "2024-10-28T17:50:00.000Z",
    },
    {
      id: "exp-11",
      groupId: "693d1183-dd55-4292-a1af-e2ef8aa8db97",
      ...
      createdAt: "2024-10-27T15:10:00.000Z",
    },
    {
      id: "exp-12",
      groupId: "693d1183-dd55-4292-a1af-e2ef8aa8db97",
      date: "2024-10-26",
      description: "Bike rentals (half day)",
      amount: 75,
      currency: "GBP",
      paidBy: { email: "hcooney98@gmail.com", name: "Hannah" },
      owes: [
        { email: "hcooney98@gmail.com", amount: 25 },
        { email: "adam.deegan@gmail.com", amount: 25 },
        { email: "charlie.haslam@gmail.com", amount: 25 },
      ],
      createdAt: "2024-10-26T11:20:00.000Z",
    },
    {
      id: "exp-13",
      groupId: "693d1183-dd55-4292-a1af-e2ef8aa8db97",
      ...
      paidBy: { email: "adam.deegan@gmail.com", name: "Adam" },
      owes: [
        { email: "james.portman3496@gmail.com", amount: 24 },
        { email: "adam.deegan@gmail.com", amount: 24 },
        { email: "charlie.haslam@gmail.com", amount: 24 },
        { email: "krystof.gora@gmail.com", amount: 24 },
      ],
      createdAt: "2024-10-25T16:05:00.000Z",
    },
    {
      id: "exp-14",
      groupId: "693d1183-dd55-4292-a1af-e2ef8aa8db97",
      ...
      createdAt: "2024-10-24T08:40:00.000Z",
    },
  ],
